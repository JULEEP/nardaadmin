...
function Complaintbox() {
  ...
  const planssearch = e => {
    ...
    axios
      .post(
        URLS.GetArticleSearch + `${e.target.value}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      ...
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs
            ...
            breadcrumbItem="Published Article List"
          />
          <Row>
            <Col md={12}>
              <Card>
                <CardBody>
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <h4 className="card-title mb-0">Articles ({plans.length})</h4>
                  ...
                  {loading && (
                    <div className="text-center mb-3">
                      ...
                      <small className="text-muted ms-2">Loading articles...</small>
                    </div>
                  )}
                          ...
                          <tr>
                            <td colSpan="9" className="text-center py-4">
                              <div className="text-muted">
                                ...
                                <h5 className="mt-2">No articles found</h5>
