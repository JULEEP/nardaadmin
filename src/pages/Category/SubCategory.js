...
const Banner = () => {
  ...
  const AddBanner = () => {
    ...
    axios
      .post(URLS.AddSubCategory, dataArray, {
  ...
  const EditBanner = () => {
    ...
    axios
      .put(URLS.UpdateSubCategory + formid, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const DeleteBanner = data => {
    ...
    var remid = data._id
    axios
      .delete(URLS.DeleteSubCategory + remid, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        URLS.GetSubCategorySearch + `${e.target.value}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
