...
function Addnews() {
  ...
  const handleSubmit = e => {
    ...
    if (form.youtube === "true" && form.videourl) {
  ...
  const AddPosters = () => {
    ...
    dataArray.append("videourl", form.videourl)
  ...
  const handleChange = e => {
    ...
    // Reset YouTube error when URL changes
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Narada" breadcrumbItem="Add Video" />
          <Form
            onSubmit={e => {
              handleSubmit(e)
            }}
                        ...
                        <>
                          <Col md={4}>
                            <div className="mb-3">
                              ...
                              <textarea
                                type="text"
                                className={`form-control ${youtubeError ? 'is-invalid' : ''}`}
