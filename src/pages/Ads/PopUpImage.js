...
const PopUp = () => {
  ...
  const EditPlans = () => {
    ...
    axios
      .post("http://13.51.235.130:8003/admin/ads/adsImageUpdate", dataArray, {
  ...
  const GetAllPlans = () => {
    ...
    axios
      .get("http://13.51.235.130:8003/admin/getAllAdsImages", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(res => {
        if (res.data.success) {
  ...
  const deleteAd = () => {
    ...
    axios
      .delete(`http://13.51.235.130:8003/admin/deletepopup/${planToDelete._id}`, {
        headers: { 
  ...
  const AddNewPopup = () => {
    ...
    axios
      .post("http://13.51.235.130:8003/admin/createadsimg", dataArray, {
        headers: {
          Authorization: `Bearer ${token}`,
